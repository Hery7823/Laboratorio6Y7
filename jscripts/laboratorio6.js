...
function resolverDivisa(monedaOrigen,monedaDestino)
{
     ...
     listaMonedaOrig = operMoneda(tempoOrigen);
     listaMonedaDest = operMoneda(tempoDestino);


     if(listaMonedaOrig == listaMonedaDest)
     {
          oper = cantidadDinero;
          panelResultado = document.getElementById('resultado').innerHTML=('Su Conversion es de: $'+oper);
...
//Vector Moneda origen
var moneda = ['Elige tu Moneda','Dollar','Peso Mexicano','Peso Colombiano','Euros','Bolivar'];
var cambio = ['Elige moneda de cambio','Dollar','Peso Mexicano','Peso Colombiano','Euros','Bolivar'];
